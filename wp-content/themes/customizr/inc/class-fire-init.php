  ...
  class TC_init {
      ...
      function __construct () {
          ...
          $this -> default_slides     = array(
                                            1 => array(
                                              'title'         =>  'Welcome to Forest City Diving Club',
                                              'text'          =>  'Learn about our awesome programs by clicking',
                                              'button_text'   =>  'Learn to Dive',
                                              'link_id'       =>  null,
                                              'link_url'      =>  'http://fcdiving.esy.es/wp/?page_id=35',
                                              'active'        =>  'active',
                                              'color_style'   =>  '',
                                              'slide_background'       =>  sprintf('<img width="1200" height="500" src="%1$s" class="" alt="%2$s" />',
                                                                          TC_BASE_URL.'inc/assets/img/dive1.jpg',
                                                                          __( '' , '' )
                                                                  )
                                            ),
                                            ...
                                            2 => array(
                                              ...
                                              'color_style'   =>  '',
                                              'slide_background'       =>  sprintf('<img width="1200" height="500" src="%1$s" class="" alt="%2$s" />',
                                                                          TC_BASE_URL.'inc/assets/img/dive2.jpg',
                                                                          __( '' , '' )
                                                                  )
                                            ),
                                            ...
                                            3 => array(
                                              ...
                                              'color_style'   =>  '',
                                              'slide_background'       =>  sprintf('<img width="1200" height="500" src="%1$s" class="" alt="%2$s" />',
                                                                          TC_BASE_URL.'inc/assets/img/dive3.jpg',
                                                                          __( '' , '' )
                                                                  )
                                            )
          );///end of slides array
